...
public class MasterTestKuki2 {
    public static void main(String[] args) throws Exception {
        ...
        batch.addLocator(0, BaseLocator.holdingRegister(10, 85, DataType.FOUR_BYTE_FLOAT));
        batch.addLocator(1, BaseLocator.holdingRegister(10, 89, DataType.FOUR_BYTE_FLOAT));
